...
void delay (long int temps)
{
   volatile long int i=0;
	...
	/* Aqui tenemos un contador, que va de 0 a la cantidad indicada sumando 
	una unidad a cada ciclo hasta que cumple el tiempo indicado */
   do{
	   i++;
   }while(i < temps);
...
void main(void)
{
		...
		/* Iniciamos los botones y Leds. */
	  	...
	  	Init_UART();
	  	init_VARS();					// Inicializamos variables
